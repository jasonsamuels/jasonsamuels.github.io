...
The theme this week was leadership. Readings in each class centered on organizational culture, although from different angles. The SHRM readings emphasized the importance of leadership that nurtures, advocated for a paradigm where leadership is understood more as a verb than a noun, and showed how conditions which foster intrinsic motivation lead to better results than command-and-control regimes that rely on coercion to drive results. The readings for Strategic Planning this week focused on organizational culture from another standpoint - that when an organization does well at understanding its own identity can clearly articulate its purpose, it fosters a strong bond with the individuals in it, which in turn leads to a sense of mission that promotes intrinsic motivation and leads to better work outcomes.
